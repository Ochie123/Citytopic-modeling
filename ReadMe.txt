...
Run the csv file through the (Topic Modeling algorithm)- only change the location/name

Incase you encounter an error send a request to: youngpope07@gmail.com
